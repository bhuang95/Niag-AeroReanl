#!/bin/bash
#SBATCH -J 202007glbus_h2n
#SBATCH -A niagara
#SBATCH -n 1
#SBATCH -t 24:00:00
#SBATCH -p service
#SBATCH -D ./
#SBATCH -o /collab1/data/Bo.Huang/dataTransfer/AeroReanl/ChgresGDAS/glbus_h2n_202007.out
#SBATCH -e /collab1/data/Bo.Huang/dataTransfer/AeroReanl/ChgresGDAS/glbus_h2n-202007.out

module load globus-cli

set -x

SDATE=$(cat SDATE_202007.info)  #2020071300
EDATE=$(cat EDATE_202007.info)  #2020071318
HRS="00 06 12 18"
CYCINC=24
